<div>
    ...
    <x-project-preview
        ...
        description="LÜM is a social media, music discovery, and streaming application that allows fans to directly support their favorite emerging artists."
    />
    ...
    <x-project-preview
        ...
        description="Successful side project turned funded start-up (RIP 😥). Created a platform to allow communication using brief audio messages of popular songs. NodeJS API with native iOS, native Android, and Facebook Messenger application."
    />
